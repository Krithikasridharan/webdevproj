...
<title>Sort By Quantity in Descending</title>
...
%>
				...
				<table border=1>
				<tr><th colspan="9">AVAILABLE PRODUCT MODELS SORTED BY QUANTITY IN DESCENDING ORDER</th></tr>
				...
				<table>
				<tr><td align="left"><input type="radio" name="sort" value="sortbyIDAsc" checked>Sort by ProductModelID in Ascending</td></tr>
				<tr><td align="left"><input type="radio" name="sort" value="sortbyIdDes">Sort by ProductModelID in Descending</td></tr>
