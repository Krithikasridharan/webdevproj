...
<title>Sorted by Product Code is Descending Order</title>
...
<tr><th colspan="9">
STOCK DETAILS SORTED BY PRODUCT CODE IN ASCENDING ORDER
...
<table>
<tr><td><input type="radio" name="order" value="asc" checked>Sort by product code in Ascending order</td></tr>
