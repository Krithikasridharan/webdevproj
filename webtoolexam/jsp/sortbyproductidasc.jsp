...
<title>Sort By Product ID in Ascending</title>
...
%>
	...
	<br><br>
				...
				<table border=1>
				<tr><th colspan="9">AVAILABLE PRODUCT MODELS SORTED BY ID IN ASCENDING ORDER</th></tr>
				...
				<table>
				<tr><td align="left"><input type="radio" name="sort" value="sortbyIDDes" checked>Sort by ProductModel ID in Descending</td></tr>
